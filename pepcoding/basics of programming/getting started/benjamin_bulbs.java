...
public class benjamin_bulbs {
    public static void main(String[] args) {
        ...
        for (int i = 1; i * i <= n; i++) {
            /*
             * The bulb numbers which have odd number of factors will be toggled odd number
             * of times and hence they will be switched on Perfect squares have odd number
             * of factors
             */
